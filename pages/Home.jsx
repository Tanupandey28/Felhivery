    ...
    return (
        <div className="bg-slate-200 w-full min-h-screen">
            ...
            <div className="w-full flex flex-wrap gap-5 px-5 justify-center items-center pt-8 pb-8">
                ...
                )):<div className="text-center text-2xl text-red-700 font-semibold pt-5">No dish found</div>}
            ...
            <div className={`w-full md:w-[40vw] h-full fixed top-0 right-0 bg-white shadow-xl p-6 transition-all duration-500 flex flex-col items-center overflow-auto ${showCart ? "translate-x-0" : "translate-x-full"}`}>
                ...
                <div className="w-full border-t-2 border-b-2 border-gray-400 mt-7 flex flex-col gap-3 p-8">
                ...
                <div className="w-full flex justify-between items-center p-9">
                    ...
                    <button className="w-[80%] p-3 bg-green-500 rounded-lg text-white hover:bg-green-400 transition-all" onClick={()=>{
